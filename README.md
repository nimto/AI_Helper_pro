...
| 버전 | 다운로드 | 릴리즈 날짜 |
|------|----------|-------------|
| **v0.1.10** (최신) | [AI Helper Pro-Windows-0.1.10-Setup.exe](https://github.com/nimto/AI_Helper_pro/releases/download/v0.1.10/AI.Helper.Pro-Windows-0.1.10-Setup.exe) | 2026-01-05 |
...
2. 다운로드한 `AI Helper Pro-Windows-0.1.10-Setup.exe` 실행
